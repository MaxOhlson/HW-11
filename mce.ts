...
function literal_value(component: Literal): Value {
    return is_pair(component) ? false : component.value;
}

export function make_literal(value: Value): Literal {
    return {tag: "literal", value: value};
}

function is_name(component: Component): component is Name {
    return is_pair(component) ? false :component.tag === "name";
}

export function make_name(symbol: Symbol): Name {
...
function is_assignment(component: Component): component is Assignment {
    return is_pair(component) ? false : component.tag === "assignment";
}
...
function is_declaration(component: Component): component is Declaration {
    return is_pair(component) ? false : component.tag === "constant_declaration" ||
...
export function make_lambda_expression(parameters: List<Name>, body: Component): Lambda {
...
function is_function_declaration(component: Component): component is Function {
    return is_pair(component) ? false : component.tag === "function_declaration";
}
...
function is_return_statement(component: Component): component is ReturnStatement {
   return is_pair(component) ? false : component.tag ===  "return_statement";
}
...
function is_conditional(component: Component): component is Conditional {
    return is_pair(component) ? false : component.tag === "conditional_expression";
}
...
function is_block(component: Component): component is Block {
    return is_pair(component) ? false : component.tag ===  "block";
}
...
export function make_application(function_expression: Expression, argument_expressions: List<Expression>): Application {
...
function is_application(component: Component): component is Application {
   return is_pair(component) ? false : component.tag ===  "application";
}
...
function is_compound_function(f: Value): f is CompoundFunction {
    return head(f) === "compound_function";
}
...
function is_return_value(value: Value): value is ReturnValue {
    return head(value) === "return_value";
}
